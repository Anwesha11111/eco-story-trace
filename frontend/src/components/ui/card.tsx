  ...
  "rounded-2xl transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        eco: "eco-gradient text-card-foreground shadow-soft border border-border/50",
        verified: "bg-gradient-to-br from-primary/5 to-secondary/5 border-2 border-primary/20 shadow-glow",
      },
    },
    defaultVariants: {
      variant: "default",
